...
macro(os_target_config)
    if(NOT BUILD_WITH_ZMQ)
        ...
        if(LIBZMQ_FOUND)
            include_directories(SYSTEM ${LIBZMQ_INCLUDE_DIRS})
            link_directories(${LIBZMQ_LIBRARY_DIRS})
            list(APPEND librealsense_PKG_DEPS "libzmq")
        else()
            message( FATAL_ERROR "libzmq is required, please set option BUILD_WITH_ZMQ=true in CMake" )
        endif(LIBZMQ_FOUND)
    else()
        include(CMake/external_libzmq.cmake)
        set(LIBZMQ_LIBRARIES ${LIBZMQ_LIBRARY_DIRS}/libzmq.so)
    endif()
endmacro()
