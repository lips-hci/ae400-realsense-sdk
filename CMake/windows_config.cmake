...
macro(os_set_flags)
    ...
    if(FORCE_RSUSB_BACKEND)
        ...
        if(NOT BUILD_WITH_ZMQ)
            set(LIBZMQ_LIBRARY_DIRS third-party/libzmq/windows/lib)
            link_directories(${LIBZMQ_LIBRARY_DIRS})
            set(LIBZMQ_LIBRARIES libzmq-${CMAKE_VS_PLATFORM_TOOLSET}-mt-4_3_2)
            set(LIBZMQ_LOCAL_INCLUDE_PATH third-party/libzmq/windows/include)
        else()
